...
export const STYLE_FEED_ITEMS: StyleFeedItem[] = [
  ...
  },
  {
    ...
    preview: "/prompt-animal-crossing.webp",
    basePrompt:
  ...
  },
  {
    ...
    title: "태닝키티",
    style: "tanning-kitty",
    preview: "/prompt-tanning-kitty.webp",
    basePrompt:
